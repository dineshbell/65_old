...
import dietImg from '../../img/dietbgs.jpg'
...
const Diet = () => {
  return (
    <div className='bg-sky-50 pb-10'>
      ...
      <h1 className='text-center text-3xl text-lightblue-600 pt-10'>Here are some tips for healthy Diet</h1>
      ...
      {/* Cards */}
      <h1 className='text-center text-3xl text-lightblue-600 pt-20'>Example Menu for you</h1>
          ...
          <div className="flex flex-wrap">
            <div className="p-4 md:w-1/2 ">
              <div
                ...
                <div className="p-8">
                  <h1 className="title-font text-2xl font-medium text-center text-lightblue-700 mb-3">Breakfast</h1>
            ...
            <div className="p-4 md:w-1/2 ">
              <div
                ...
                <div className="p-8">
                  <h1 className="title-font text-2xl font-medium text-center text-lightblue-700 mb-3">Lunch</h1>
                  <ul className='list-disc'>
            ...
            <div className="p-4 md:w-1/2 ">
              <div
                className="h-full shadow-sm shadow-green-100 border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden bg-white">
                <div className="p-8">
                  <h1 className="title-font text-2xl font-medium text-center text-lightblue-700 mb-3">Dinner</h1>
                  <ul className='list-disc'>
            ...
            <div className="p-4 md:w-1/2 ">
              <div
                className="h-full shadow-sm shadow-green-100 border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden bg-white">
                <div className="p-8">
                  <h1 className="title-font text-2xl font-medium text-center text-lightblue-700 mb-3">Snack</h1>
                  <ul className='list-disc'>
      ...
      {/* Remember */}
      <h1 className='text-center text-3xl text-lightblue-600 pt-20 pb-5'>Remember Sunita...</h1>
