            ...
            <div className='absolute top-16 bg-sky-50'>
                <div style={{ backgroundImage: `url(${nature})` }}>
                    <div className="container flex flex-col items-center px-4 py-16 pb-24 mx-auto text-center lg:pb-56 md:py-32 md:px-10 lg:px-32 ">
                        <h1 className="text-4xl font-bold leading-none sm:text-6xl xl:max-w-3xl text-lightblue-700">Hey Sunita! let's enjoy life to it's fullest!</h1>
                ...
                <div className='h-60 -mt-32 -z-50 '>
                    <p className='w-full pb-4 absolute text-green-600 text-center bottom-0 bg-lightblue-100'>
                        <a href="https://github.com/dineshbell">Made by @Dinesh  </a>
                    </p>
                </div>
                ...
                <div className=" -mt-48 mb-10 py-4 px-4 pt-16 bg-blue-100 flex flex-col items-center text-center">
                    <div className='max-w-4xl text-lg px-4'>
                        <h1 className='w-full text-center text-3xl py-4 font-semibold mb-2 text-gray-700'><span className='text-green-600'>MedPlus</span>  is your guide to Stay Healthy and happy 😊</h1>
                        ...
                        <ul className='text-gray-700'>
                            <li className='hover:text-lightblue-600'>Get active</li>
                            <li className='hover:text-lightblue-600'>Take supplements as necessary</li>
                            <li className='hover:text-lightblue-600'>Eat a healthy diet</li>
                            <li className='hover:text-lightblue-600'>Wash your hands frequently</li>
                            <li className='hover:text-lightblue-600'>Learn how to manage stress</li>
                            <li className='hover:text-lightblue-600'>Get plenty of rest</li>
                            <li className='hover:text-lightblue-600'>Take steps to prevent infections</li>
                            <li className='hover:text-lightblue-600'>Schedule annual physicals</li>
                            <li className='hover:text-lightblue-600'>Avoid contact with people who are sick</li>
                        </ul>
                    </div>
